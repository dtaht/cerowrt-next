...
$(eval $(call nf_add,IPT_NAT6,CONFIG_IP6_NF_TARGET_MASQUERADE, $(P_V6)ip6t_MASQUERADE))
$(eval $(call nf_add,IPT_NAT6,CONFIG_IP6_NF_TARGET_NPT, $(P_V6)ip6t_NPT))
...
IPT_BUILTIN += $(IPT_NAT6-y) $(IPT_NAT6-m)
